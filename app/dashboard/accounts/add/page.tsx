...
import { Loader2, HelpCircle, AlertTriangle, Copy, Check, Info, ArrowLeft } from "lucide-react"
...
export default function AddAccountPage() {
  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      <div className="mb-6">
        <Link href="/dashboard/accounts" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl font-bold">Добавить аккаунт Wildberries</CardTitle>
          <CardDescription>Подключите ваш аккаунт Wildberries для управления отзывами</CardDescription>
        </CardHeader>
        <CardContent>
